...
public class calculatriceController {
    ...
    private String currenNumber = "";

    private String calculationType;

    @FXML
    void addAction(ActionEvent event){calculationSetup("+");}
    @FXML
    void minusAction(ActionEvent event){calculationSetup("-");}
    @FXML
    ...
    void calculate(ActionEvent event){
        ...
        int secondNumberInt = Integer.parseInt(currenNumber);

        switch (calculationType){
            case "+" -> {
                int calculatedNumber = firstNumberInt + secondNumberInt;
                savedNumbers.setText(firstNumberInt + " + " + currenNumber + " = " + calculatedNumber);
    ...
    public void updateTextField(){textField.setText(currenNumber);}
